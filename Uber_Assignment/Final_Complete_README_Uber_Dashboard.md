...
(Include chart code and description...)
...
## 📋 Table: Trips per Day
(Include table code and description...)
...
## 🌡️ Heatmaps
(Include code for all types and descriptions...)

## 🗺️ Leaflet Map
(Include leaflet map rendering code and description...)

## 🤖 Prediction Model
(Include decision tree training code and description...)

## 🌲 Decision Tree Plot
(Include rpart.plot rendering code and description...)

## 📊 Pivot Table
(Include pivot table code and description...)
